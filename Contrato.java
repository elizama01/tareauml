...
int Agno,Mes,Dia,DiaTermino,MesTermino,AgnoTermino;
...
public Contrato(Trabajador trab1 ) {
 this.trab1=trab1;
          
    }	public  void GenerarContrato() {
	long SalarioMensual1= (long) (SalarioMensual*12);
            ...
            System.out.println("Usted ganara "+ SalarioMensual+" MIl Pesos  Al mes" );
            System.out.println("Usted ganara "+ (SalarioMensual1)+" Mil PEsos  Por año" );
